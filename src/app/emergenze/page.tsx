      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container-custom py-24 lg:py-32 w-full">
          <div className="max-w-3xl mx-auto text-center">
            {/* Alert badge */}
            <div className="inline-flex items-center gap-2 rounded-full bg-red-500/15 border border-red-500/25 px-4 py-1.5 mb-8">
            ...
            {/* Title */}
            <h1 className="text-4xl sm:text-5xl lg:text-hero font-bold text-white mb-6 tracking-tight">
              {EMERGENZE.hero.title}
            </h1>

            {/* Description */}
            <p className="text-lg text-white/70 leading-relaxed max-w-xl mx-auto mb-14">
              {EMERGENZE.description}
            </p>

            {/* Emergency Number Card */}
            <div className="relative rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm p-8 lg:p-12 mb-10">
              {/* Subtle glow effect */}
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="block text-5xl sm:text-6xl lg:text-7xl font-bold text-white hover:text-red-300 transition-colors duration-300 tracking-tight"
                >
                  {EMERGENZE.number}
                </a>
            ...
            <Button
              asChild
              size="lg"
              className="bg-red-600 hover:bg-red-700 text-white text-base px-10 shadow-lg shadow-red-900/20"
            >
