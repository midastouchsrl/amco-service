    ...
    <footer className="bg-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-10 lg:py-20">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-14">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold text-white/40 tracking-wider uppercase mb-4 lg:mb-5">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 lg:mt-14 pt-6 lg:pt-8 border-t border-white/10">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:gap-4">
            <p className="text-xs lg:text-sm text-white/35">{FOOTER.copyright}</p>
